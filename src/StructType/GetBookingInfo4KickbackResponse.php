...
class GetBookingInfo4KickbackResponse extends AbstractStructBase
{
     ...
     */
    protected array $MidocoBookingInfo4Kickback = [];
    /**
     ...
     */
    public function __construct(array $midocoBookingInfo4Kickback = [])
    {
        $this
     ...
     */
    public function setMidocoBookingInfo4Kickback(array $midocoBookingInfo4Kickback = []): self
    {
