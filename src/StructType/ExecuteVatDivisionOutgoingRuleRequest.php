...
class ExecuteVatDivisionOutgoingRuleRequest extends AbstractStructBase
{
     ...
     */
    public function __construct(array $midocoVatCode = [], ?\Pggns\MidocoApi\Order\StructType\MidocoSellItemType $midocoSellItem = null, ?\Pggns\MidocoApi\Order\StructType\MidocoOrderType $midocoOrder = null)
    {
        $this
