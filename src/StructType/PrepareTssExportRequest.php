...
class PrepareTssExportRequest extends AbstractStructBase
{
     ...
     * @param string $tssId
     */
    public function __construct(array $unitName = [], ?bool $complete = null, ?string $dateFrom = null, ?string $dateTo = null, ?int $transactionNoFrom = null, ?int $transactionNoTo = null, ?int $receiptNo = null, ?string $tssId = null)
    {
        $this
