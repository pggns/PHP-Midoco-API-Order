...
class GetAgencySettlementLevelDetailsResponse extends AbstractStructBase
{
     ...
     */
    protected array $MidocoAgencySettlementLevelDetail = [];
    /**
     ...
     */
    public function __construct(array $midocoAgencySettlementLevelDetail = [])
    {
        $this
     ...
     */
    public function setMidocoAgencySettlementLevelDetail(array $midocoAgencySettlementLevelDetail = []): self
    {
